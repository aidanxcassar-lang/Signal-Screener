  ...
  const sectorBlocks = Object.keys(bySector).map(key => {
    ...
    return `<section class="sec">
      ...
      <table>
        ...
        <tbody>${list.map(r => `
          <tr>
            <td class="c-name"><span class="c-mark">${r.fig.logo
  ? `<img src="${esc(r.fig.logo)}" alt="" width="26" height="26" loading="lazy" decoding="async">`
...
<style>
:root{--bg:#0F1219;--surface:#161C28;--border:#232B3A;--ink:#E6EDF7;--body:#C3CEE0;
--muted:#8A9AB8;--subtle:#6B7A90;--accent:#818CF8;--green:#10B981;
