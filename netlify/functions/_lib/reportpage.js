...
import { markSVG } from '../../../content/coins.js';
...
<style>
:root{--bg:#0F1219;--surface:#161C28;--surface2:#1A2130;--border:#232B3A;--ink:#E6EDF7;
--body:#C3CEE0;--muted:#8A9AB8;--subtle:#6B7A90;--accent:#818CF8;--green:#10B981;--amber:#F59E0B;--red:#EF4444;
--mono:ui-monospace,SFMono-Regular,Menlo,monospace;--sans:Inter,system-ui,-apple-system,sans-serif}
*{box-sizing:border-box}
body{margin:0;background:var(--bg);color:var(--body);font-family:var(--sans);line-height:1.7;font-size:16.5px}
...
<nav class="crumb"><a href="/">Signal Screener</a> › <a href="/crypto-scores">Reports</a> › <a href="/sector/${esc(sector.slug)}">${esc(sector.name)}</a> › ${esc(coin.name)}</nav>

<div class="hd"><span class="hd-mark">${logo
  ? `<img src="${esc(logo)}" alt="${esc(coin.name)} logo" width="52" height="52" loading="eager" decoding="async">`
